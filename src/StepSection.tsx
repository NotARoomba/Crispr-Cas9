...
export default function StepSection({
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      whileInView="visible"
      className={`h-screen flex flex-col  ${reverse ? "md:flex-row-reverse" : "md:flex-row"} relative justify-between`}
    >
      <motion.p
        variants={item}
        className={`mx-auto md:absolute md:top-10 ${reverse ? "md:right-10" : "md:-10"} text-4xl font-bold`}
      >
        {step} Paso
      </motion.p>
      ...
      {parseInt(step[0]) < 2 ? (
        ...
        <video width="600" height="500" className="m-auto flex" autoPlay loop>
